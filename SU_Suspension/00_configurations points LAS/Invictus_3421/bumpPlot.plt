...
set y2label 'RC_z [mm]'
set xlabel 'bump [mm]'
plot "bumpAV.csv" using 1:14 w lp ls 1 axes x1y1, "bumpAV.csv" using 1:15 w lp ls 2 axes x1y2,\
	"bumpAR.csv" using 1:14 w lp ls 3 axes x1y1, "bumpAR.csv" using 1:15 w lp ls 4 axes x1y2
