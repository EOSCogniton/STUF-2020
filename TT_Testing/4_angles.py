...
def balance(r):
    ...
    def grip(a):
        ...
        Fy_fo=Fy(Fz_fo,alpha_fo,CAMBER_f(RG*a))
        Fy_fi=Fy(Fz_fi,alpha_fi,-CAMBER_f(RG*a))
        Fy_ro=Fy(Fz_ro,theta_ro,CAMBER_r(RG*a))
        Fy_ri=Fy(Fz_ri,theta_ri,-CAMBER_r(RG*a))
    ...
    Fy_fo=Fy(Fz_fo,SA_optimum(Fz_fo),CAMBER_f(RG*amax))
    Fy_fi=Fy(Fz_fi,SA_optimum(Fz_fo),-CAMBER_f(RG*amax))
    Fy_ro=Fy(Fz_ro,theta_ro,CAMBER_r(RG*amax))
    Fy_ri=Fy(Fz_ri,theta_ri,-CAMBER_r(RG*amax))
